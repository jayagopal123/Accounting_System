...
import { getAPAging } from "../../services/financialReportApi";
...
function APAgingPage() {
  ...
  const loadData = useCallback(async () => {
    try {
      setLoading(true);
      const response = await getAPAging();
    ...
    <MainLayout>
      <div className="page-card p-4">
        <div className="d-flex justify-content-between align-items-center mb-4">
          <div>
            <h5 className="page-header-title mb-1">Accounts Payable Aging</h5>
            <p className="page-header-subtitle">Outstanding supplier invoices by age</p>
          </div>
