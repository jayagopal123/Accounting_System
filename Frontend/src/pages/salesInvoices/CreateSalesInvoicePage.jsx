      ...
      <div className="page-card p-4">
        ...
        <form onSubmit={handleSubmit}>
          <div className="row g-3 mb-4">
            <div className="col-md-6"><label className="form-label">Customer Id</label><input className="form-control" value={formData.customer} onChange={(e) => setFormData((c) => ({ ...c, customer: e.target.value }))} required /></div>
