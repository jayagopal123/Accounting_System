      ...
      <div className="page-card p-4">
        ...
        <form onSubmit={handleSubmit}>
          <div className="row g-3">
            <div className="col-md-6"><label className="form-label">Customer Code</label><input className="form-control" value={formData.customerCode} onChange={(e) => updateField("customerCode", e.target.value)} required /></div>
            <div className="col-md-6"><label className="form-label">Customer Name</label><input className="form-control" value={formData.customerName} onChange={(e) => updateField("customerName", e.target.value)} required /></div>
            <div className="col-md-4"><label className="form-label">Customer Group</label><input className="form-control" value={formData.customerGroup} onChange={(e) => updateField("customerGroup", e.target.value)} /></div>
            <div className="col-md-4"><label className="form-label">Customer Type</label><input className="form-control" value={formData.customerType} onChange={(e) => updateField("customerType", e.target.value)} /></div>
